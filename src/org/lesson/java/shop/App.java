...
public class App {
    public static void main(String[] args) {
        ...
        Studente Giacomo = new Studente("Giacomo", "Rossi", 20);
        Studente Marcello = new Studente("Marcello", "Rossi", 20);
        ...
        RegistroStudenti Registro = new RegistroStudenti(Mario, Giacomo, Marcello);


        Registro.getStudentList(); 
